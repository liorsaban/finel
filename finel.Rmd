...
## pm10 and wind exempel

```{r,echo=F,fig.align="center", fig.width=8, fig.height=4.5}

#  graphics:
g1=ggplot(data_2, aes(x=date, y= PM10, color=WS_m.sec
))  + theme(legend.position = "none")+geom_line()+theme(axis.title.x=element_blank(),axis.title.y = element_text(size = 8))+ labs(title="Beer sheva", y = "pm 10 (ug/m3)")
...
## pm10 and temp exempel

```{r,echo=F,fig.align="center", fig.width=8, fig.height=4.5}

#  graphics:
g1=ggplot(data_3, aes(x=date, y= PM10, color=Temp_c
))  + theme(legend.position = "none")+geom_line()+theme(axis.title.x=element_blank(),axis.title.y = element_text(size = 8))+ labs(title="Haifa", y = "pm 10 (ug/m3)")
...
## pm10 TO WEATHER COR MATRIX

```{r,echo=F,fig.align="center", fig.width=8, fig.height=4.5}

kable(cor_lokalty,caption = "pm10 TO WEATHER COR MATRIX")%>%
  kable_styling(c("striped", "bordered"))


```

## WEATHER COR TO pm10 COR TO LAND USE MATRIX

```{r,echo=F,fig.align="center", fig.width=8, fig.height=4.5}


kable(mc_data ,caption = "WEATHER COR TO pm10 COR TO LAND USE MATRIX")%>%kable_styling(c("striped", "bordered")) 
